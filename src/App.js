    ...
    <div className=''>
      <div className="h-screen w-screen flex justify-center items-center relative">
        ...
        <div className='absolute top-5 left-5 flex justify-center items-center z-10'>
          <a href="https://x.com/ODonsol" className='z-10'>
          ...
          <a href="https://t.me/ODonsol" className=''>
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className='size-10 md:size-12 md:hover:scale-105 transition ease-in-out duration-150' fill="#45D2FF" viewBox="0 0 50 50">
      ...
      <div className="h-min py-[15%] w-screen border-y-2 bg-[#0a192f] flex flex-col items-center relative">
        <h2 className="text-4xl md:text-6xl text-[#45D2FF] mb-8 font-custom font-semibold">Roadmap</h2>
        <div className="w-11/12 md:w-2/3">
          <div className="relative">
            <div className="absolute w-1 bg-gradient-to-b from-[#45D2FF] to-[#004466] h-full left-1/2 transform -translate-x-1/2"></div>

            {[
              { id: 1, title: "KOTH", description: "Paying Dex" },
              { id: 2, title: "Migration", description: "Dev burn" },
              { id: 3, title: "On Ray", description: "Dex Ads" },
              { id: 4, title: "On Ray", description: "Fatality Bot" },
              { id: 5, title: "15 min", description: "Finders trending" }
            ].map((item, index) => (
              <div
                key={item.id}
                className={`mb-8 flex ${index % 2 === 0 ? 'justify-start' : 'justify-end'} w-full`}
              >
                <div className={`w-5/12 md:w-2/5 p-4 bg-[#112240] rounded shadow-lg`}>
                  <h3 className="text-lg md:text-xl text-[#45D2FF] font-semibold mb-2">{item.title}</h3>
